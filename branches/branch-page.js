  ...
  async init() {
    ...
    try {
      ...
      if (!pRes || !Array.isArray(pRes)) {
        pRes = [
          { id: "proj-dcs-geumgang-01", branch_id: "daejeon-chungnam-sejong", branch_name: "대전·충남·세종 지부", title: "천내리습지 생태계교란식물 제거사업", client: "기후부 금강유역환경청", target_species: ["가시박", "단풍잎돼지풀", "환삼덩굴"], location_name: "충청남도 금산군 제원면 천내리습지 1·2·3구간", lat: 36.126830, lng: 127.589850, total_area_m2: 162000, total_harvest_kg: 5130, live_dashboard_url: "https://yongtae999.github.io/geumgang-drone-monitor/" },
          ...
          { id: "proj-jb-goldenrod-02", branch_id: "jeonbuk", branch_name: "전북특별자치도 지부", title: "2026년 생태계교란 식물(양미역취 등) 제거사업", client: "전북지방환경청", organizer: "(사)야생생물관리협회 전북지부", status: "pending", status_label: "미실시 (대기)", target_species: ["양미역취", "가시박", "환삼덩굴"], location_name: "전북 익산시 춘포면 만경강 일원", lat: 35.895567, lng: 126.993717, total_area_m2: 0, total_harvest_kg: 0, live_dashboard_url: "https://yongtae999.github.io/geumgang-drone-monitor/?project=chunpo" }
        ];
      }
