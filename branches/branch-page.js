    ...
    try {
      ...
      if (!pRes || !Array.isArray(pRes)) {
        pRes = [
          ...
          { id: "proj-jb-goldenrod-02", branch_id: "jeonbuk", branch_name: "전북특별자치도 지부", title: "2026년 생태계교란 식물(양미역취 등) 제거사업", client: "전북지방환경청", organizer: "(사)야생생물관리협회 전북지부", status: "ongoing", status_label: "진행중", target_species: ["양미역취", "가시박", "환삼덩굴"], location_name: "전북 익산시 춘포면 만경강 일원", lat: 35.895567, lng: 126.993717, total_area_m2: 24000, total_harvest_kg: 1250, live_dashboard_url: "https://yongtae999.github.io/geumgang-drone-monitor/?project=chunpo" }
        ];
      }
